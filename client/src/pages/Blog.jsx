                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            ...
                            <div className="blog-box">
                                <Link to="#!" className="font-color-black font-size">Page builder included</Link>
                                ...
                                <div className="vertical-space-20"></div>
                                <Link to="#!" className="font-color-orange font-bold">Read more<i className="fa fa-long-arrow-right"></i></Link>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                            <img src="./assets/imags/blog2.jpg" className="blog-image" alt="" />
                            <div className="blog-box">
                                <Link to="#!" className="font-color-black font-size">Retina ready graphics</Link>
                                <p className="float-left font-color-black width"><Link to="#!" className="font-color-black font-size-14">27
                                    Mar, 2018</Link> | <Link to="#!" className="font-color-black font-size-14">11 min read</Link></p>
                                <p className="space10">Fusce aliqm nonlips dictmst dapib alorem accman pellenl tesque in temor aliqm
                                    npion dmst dapib honcs fusce aliqm non dictmst . </p>
                        ...
                        <div className="col-lg-4 col-md-6">
                            ...
                            <div className="blog-box">
                                <Link to="#!" className="font-color-black font-size">Simple blog post</Link>
                                <p className="float-left font-color-black width"><Link to="#!" className="font-color-black font-size-14">27
                                    Mar, 2018</Link> | <Link to="#!" className="font-color-black font-size-14">11 min read</Link></p>
                                <p className="space10">Fusce aliqm nonlips dictmst dapib alorem accman pellenl tesque in temor aliqm
                                    npion dmst dapib honcs fusce aliqm non dictmst . </p>
                        ...
                        <div className="col-lg-4 col-md-6">
                            ...
                            <div className="blog-box">
                                <Link to="#!" className="font-color-black font-size">Cookie cotton candy</Link>
                                <p className="float-left font-color-black width"><Link to="#!" className="font-color-black font-size-14">27
                                    Mar, 2018</Link> | <Link to="#!" className="font-color-black font-size-14">11 min read</Link></p>
                                <p className="space10">Fusce aliqm nonlips dictmst dapib alorem accman pellenl tesque in temor aliqm
                                    npion dmst dapib honcs fusce aliqm non dictmst . </p>
                        ...
                        <div className="col-lg-4 col-md-6">
                            ...
                            <div className="blog-box">
                                <Link to="#!" className="font-color-black font-size">Award-winning design</Link>
                                <p className="float-left font-color-black width"><Link to="#!" className="font-color-black font-size-14">27
                                    Mar, 2018</Link> | <Link to="#!" className="font-color-black font-size-14">11 min read</Link></p>
                                <p className="space10">Fusce aliqm nonlips dictmst dapib alorem accman pellenl tesque in temor aliqm
                                    npion dmst dapib honcs fusce aliqm non dictmst . </p>
                        ...
                        <div className="col-lg-4 col-md-6">
                            ...
                            <div className="blog-box">
                                <Link to="#!" className="font-color-black font-size">Mobile friendly</Link>
                                <p className="float-left font-color-black width"><Link to="#!" className="font-color-black font-size-14">27
                                    Mar, 2018</Link> | <Link to="#!" className="font-color-black font-size-14">11 min read</Link></p>
                                <p className="space10">Fusce aliqm nonlips dictmst dapib alorem accman pellenl tesque in temor aliqm
                                    npion dmst dapib honcs fusce aliqm non dictmst . </p>
